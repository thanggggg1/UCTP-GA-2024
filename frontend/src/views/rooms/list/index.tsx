...
import ModalImportRooms from "../components/ModalImportRooms";

export const RoomsView = memo(function RoomsView() {
            ...
            <TabsContent value="all">
              <Card x-chunk="dashboard-06-chunk-0">
                <CardHeader>
                  ...
                  <CardDescription>
                    Manage rooms and their courses in your university.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <RoomsTable />
