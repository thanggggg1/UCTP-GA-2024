...
import ModalImportCourses from "../components/ModalImportCourses";

export const CoursesView = memo(function CoursesView() {
            ...
            <TabsContent value="all">
              <Card x-chunk="dashboard-06-chunk-0">
                <CardHeader>
                  ...
                  <CardDescription>
                    Manage courses and their courses in your university.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <CoursesTable />
